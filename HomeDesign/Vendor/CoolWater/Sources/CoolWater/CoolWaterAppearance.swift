...
/// `modelMatrix` is in UntoldEngine entity/scene-local space. Render-extension camera
/// matrices already apply `SceneRootTransform`; callers must not bake it into this model.
